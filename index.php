...
<body class="page-transition">
    ...
    <div class="container-fluid">
        <div class="row justify-content-center align-items-center" style="height:100vh;">
            <div class="col-md-6 col-lg-4 page-login">
                <form class="form-signin">
                    ...
                    <div class="checkbox mb-3">
                        ...
                        <a href="register.php" class="float-right"><i>I don't have account</i></a>
                    </div>
                    <!-- <button class="btn btn-lg btn-info btn-block" type="submit"><a href="dashboard/index.php"
                            class="text-white">Sign
                            In</a></button> -->
                    <a href="dashboard/index.php" class="btn btn-lg btn-info btn-block text-white">Sign In</a>
